...
namespace API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<IdentityRole> roleManager, IJWTService jwtService, IWorkerCategoryService workerCategoryService)
        {
